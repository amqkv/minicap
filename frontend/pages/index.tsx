    ...
    <>
      <Flex p="30px">
        <Box direction="column" background="white.100" w="50%" p={20} rounded={6}>
          ...
          <p>
            Some more description here lmao badabing badaboom hehe hihi hoho Ideally long enough to take 3-4 lines like
            this So that it looks legit and better lololololololollolollololol
          </p>
          <LoginLogoutButton />
        </Box>
